...
<html lang="en">
 ...
 /* border: 2px solid #2dc997;*/
  ...
  <div class="site-wrap">
   ...
   <table class="tbl" cellpadding="2px">
      <tr>
       <th colspan="4" align="center"><h3><u> New Employee</u></h3></th>
   </tr>
   <tr>
     <th colspan="2" align="left">Name :</th>
     <th colspan="2"><input type="text" id="tf" name="emp_name"></th>
   </tr>
   
   <tr>
       <th colspan="2" align="left">Email ID :</th>
       <th colspan="2"><input type="email" id="tf" name="emp_email" value="@gmail.com"></th>
   </tr>
   <tr>
     <th colspan="2" align="left"> Employee ID :</th>
     <th colspan="2"><input type="text" id="tf" name="emp_id"></th>
 </tr>
 <!-- <tr>
 ...
 <tr>
    ...
    <th colspan="2"><input type="number" id="tf" name="emp_mobile"></th>
   </tr>
   
   <tr>
       <th colspan="2" align="left"> Address :</th>
       <th colspan="2"><input type="text" id="tf" name="emp_add"></th>
     </tr>
     <tr>
       <th colspan="2" align="left"> Designation</th>
        <th colspan="2"><select name="emp_deg" id="tf">
      ...
      <tr>
       <th colspan="2" align="left">Join Date :</th>
       <th colspan="2"><input type="date" id="tf" name="emp_date"></th>
     </tr>
     <tr>
 ...
 <table class="tbl2">
    <tr>
       <th colspan="4" align="center"><input type="submit" id="btn" value="REGISTER" name="emp_reg"></th>
